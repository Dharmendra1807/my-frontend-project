            ...
            <div className='bg-gray-700 dark:bg-gray-900 p-7 my-2 drop-shadow-md rounded-lg'>
              <div className="flex flex-wrap">
                <div className=" w-96 px-3">
                  ...
                  <Field className="appearance-none block w-full my-2 bg-white text-gray-900 border border-gray-700 rounded py-2 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                    id="Create_Group"
                    name='Create_Group'
                    type="text"
                    ...
                    values.term.map((term, index) => (
                      <div key={index} className='my-5 flex flex-wrap' >
                        ...
                        <div className=" w-[410px] px-3">
                          ...
                          <input
                            ref={addRefs}
                            className="appearance-none block w-full my-2 bg-white text-gray-900 border border-gray-700 rounded py-2 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
